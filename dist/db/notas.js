...
exports.countNotasByProfessor = countNotasByProfessor;
...
exports.getAuditoriaByProfessor = getAuditoriaByProfessor;
...
function countNotasByProfessor(id_professor) {
    return __awaiter(this, void 0, void 0, function* () {
        const connection = yield (0, db_1.open)();
        try {
            const result = yield connection.execute(`
...
function getAuditoriaByProfessor(id_professor) {
    return __awaiter(this, void 0, void 0, function* () {
        const connection = yield (0, db_1.open)();
        try {
            const result = yield connection.execute(`SELECT DESCRICAO as "descricao", DATA_HORA as "data_hora" FROM AUDITORIA WHERE id_professor = :id_professor ORDER BY DATA_HORA DESC`, [id_professor]);
            return result.rows;
        }
        finally {
            yield (0, db_1.close)(connection);
