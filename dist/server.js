...
app.get("/alunos/turma/:id_turma", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const alunos = yield (0, alunos_1.getAllAlunosByTurma)(Number(id_turma));
        if (alunos) {
            res.json(alunos);
        }
        else {
...
app.post("/recuperar-senha", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (nodemailer_1.default.getTestMessageUrl(info)) {
            console.log('[RECUPERAR-SENHA] Preview URL:', nodemailer_1.default.getTestMessageUrl(info));
        }
        res.json({ message: "E-mail de recuperação enviado com sucesso!", previewUrl: nodemailer_1.default.getTestMessageUrl(info) || null });
    }
    catch (err) {
