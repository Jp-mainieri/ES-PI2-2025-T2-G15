...
CREATE TABLE WEBAPP.INSTITUICAO (
  id_instituicao NUMBER PRIMARY KEY,
  nome VARCHAR2(200) NOT NULL
);

CREATE TABLE WEBAPP.CURSO (
...
CREATE TABLE WEBAPP.DISCIPLINA (
...
CREATE TABLE WEBAPP.PROFESSORES (
...
CREATE TABLE WEBAPP.COMPONENTE_NOTA (
...
CREATE TABLE WEBAPP.TURMAS_ALUNOS (
...
CREATE TABLE WEBAPP.PROFESSORES_TURMAS (
